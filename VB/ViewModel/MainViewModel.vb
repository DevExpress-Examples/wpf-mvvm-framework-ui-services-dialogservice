...
Public Class MainViewModel
	...
	Public Sub ShowRegistrationForm()
		...
		Dim registerCommand As New UICommand() With {
			.Caption = "Register",
			.IsCancel = False,
			.IsDefault = True,
			.Command = New DelegateCommand(Of CancelEventArgs)(Sub(x) myExecuteMethod(), Function(x) Not String.IsNullOrEmpty(registrationViewModel.UserName))
		}

		Dim cancelCommand As New UICommand() With {
